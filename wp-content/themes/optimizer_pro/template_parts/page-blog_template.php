   ...
   ?>
    ...
    <div class="lay4">
        <div class="center">
            ...
            <div class="lay4_wrap <?php echo $nosidebar; ?>">
                ...
                <?php if(!empty($optimizer['show_blog_thumb']) &&  $optimizer['blog_layout_id'] !== '3' ) { ?>
                        ...
                        <div class="post_content">
                         ...
                         <!--META INFO START-->   
                            ...
                            <div class="single_metainfo">
                            	<!--DATE-->
                                <?php if($optimizer['blog_layout_id'] == '1'){ ?>
                         ...
                         <?php if($optimizer['blog_layout_id'] == '3'){ ?>
                         	<div class="blog_content_wrap"><?php the_content(); ?></div>
                         <?php } else { ?>
