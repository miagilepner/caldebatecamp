...
<?php
  ...
  if (isset($_POST['message_subject'])){ 
	  ...
	  $subject = ''.__("Someone Sent a Message From", "optimizer").''.get_bloginfo('name');  
  }
...
?>
    ...
    <div class="page_contact_wrap layer_wrapper<?php if ($optimizer['contact_latlong_id']) { ?> has_contact_map<?php } ?><?php if(!empty($optimizer['contact_sidebar'])) { ?> has_contact_sidebar<?php } ?>">
