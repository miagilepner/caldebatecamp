...
<div class="post_wrap layer_wrapper">
	...
	<div id="content">
		<div class="center">
           <!--POST START-->
			<div class="single_wrap<?php $hide_sidebar = get_post_meta( $post->ID, 'hide_sidebar', true); if (!empty($hide_sidebar ) || !is_active_sidebar( 'sidebar' )) { ?> no_sidebar<?php } ?>">
                    ...
                    <!--POST START-->
                        ...
                        <!--POST TITLE END-->
                            ...
                            <?php if (!empty ($optimizer['social_single_id']) || is_customize_preview()) { ?>
                                <div class="share_foot share_pos_<?php echo $optimizer['share_position']; ?> <?php if (empty($optimizer['social_single_id'])){ echo 'hide_share'; }?>">
