        ...
        <?php get_template_part('customizer/widget','presets'); ?>
            ...
            <ol id="optimizerTour">
              ...
              <li>
              	...
              	<p><?php _e('That\'s all! We Hope you like the Theme :) If you have any support questions related to the theme please be sure to post them on <a target="_blank" href="https://www.layerthemes.com/support/">Optimizer Support Forum.', 'optimizer'); ?></a></p>
	...
	<div class="backend_wrapper">
        ...
        <div class="blocks_wrap">
        	<div class="center">
                ...
                <!--BLOCK 3-->
                <div class="block">
                    <p><?php _e('Subscribe to our weekly newsletter to get: Free Web Resources, Insightful Marketing Tips &amp; Coupon Codes & Discounts.','optimizer'); ?></p>
                    <a href="https://www.layerthemes.com/theme/optimizer-upgrade/" target="_blank"  class="backend_btn"><?php _e('Get Free Resources','optimizer'); ?></a>
                </div> 
...
<?php if(is_page()) { ?>
				...
				?>
					...
					<?php if ($fullsidebar) : ?>
                        <div id="pagesidebar" class="full_sidebar custom_sidebar frontpage_sidebar">
