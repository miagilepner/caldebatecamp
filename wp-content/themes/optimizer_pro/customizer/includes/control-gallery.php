...
/*					var custom_uploader = wp.media({
			...
			*/
					...
					if(jQuery(this).attr('id') == 'nivo_accord_slider_add_slides'){
						...
						$('#<?php echo $id; ?>_trigger').live('click', function(index, element) {
							console.log('Clicked!');
		...
		.collection-settings.gallery-settings{ display:none;} /*Hides The Gallery Settings*/
		
        .control_gallery_preview {width: 100%;padding: 20px;background-color: #fff; border:1px solid #ddd; box-sizing:border-box; border-radius:3px; color: #aaa;margin-bottom:15px;}
		.control_gallery_preview img {width: 30%;margin-right: 3.3%; margin-bottom: 3.3%;}
