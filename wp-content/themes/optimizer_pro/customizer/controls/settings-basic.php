...
$wp_customize->add_setting('optimizer[custom_sidebar]', array(
	...
	'transport' => 'postMessage',
			...
			$wp_customize->add_control('custom_sidebar', array(
				'type' => 'text',
				'label' => __('Create New Sidebars','optimizer'),
				'description' => __('Pick a name for your sidebar and write it in this field. eg: About Page Sidebar, Contact Page Sidebar and the click the "Update" button.','optimizer'),	
	...
	$wp_customize->add_setting( 'optimizer[shop_sidebar_id]', array(
			...
			'sanitize_callback' => 'optimizer_sanitize_choices',
				...
				$wp_customize->add_control('shop_sidebar_id', array(
						'type' => 'select',
						'label' => __('Sidebar for Shop Page (Woocommerce) *','optimizer'),
						'section' => 'basic_sidebar_section',
