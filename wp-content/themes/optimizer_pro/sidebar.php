...
<?php if(!empty($optimizer['hide_mob_rightsdbr'])){ $mobsidebar = 'hide_mob_rightsdbr';}else{ $mobsidebar = ''; } ?>
    ...
    <?php if(is_home()){?>
            ...
            <?php if ( is_active_sidebar( 'sidebar' ) ) : ?>
                <div id="sidebar" class="home_sidebar <?php echo $mobsidebar; ?>">
                    <div class="widgets">  
    ...
    <?php if(is_page()){?>
		...
		if (!empty($right_sidebar )){ ?>
					<?php if ( is_active_sidebar( get_post_meta( $post->ID, 'sidebar', true) ) ) : ?>
                        <div id="sidebar" class="page_sidebar custom_sidebar <?php echo $mobsidebar; ?>">
                            <div class="widgets">          
        ...
        <?php }else{ ?>
					<?php if(optimizer_is_woocommerce_page()) { //If Wooceommerce Pages Show different Sidebar  ?>
                          <div id="sidebar" class="page_sidebar woo_sidebar" <?php echo $mobsidebar; ?>>
                              <div class="widgets">          
                    ...
                    <?php }else{ //Else show default page sidebar ?>
                        <?php if ( is_active_sidebar( 'sidebar' ) ) : ?>
                            <div id="sidebar" class="page_sidebar" <?php echo $mobsidebar; ?>>
                                <div class="widgets">          
                                        <?php dynamic_sidebar( 'sidebar' ); ?>
                                 </div>
                             </div> 
    ...
    <?php if(is_single() || is_archive() || is_search()){?>
		<?php $right_sidebar = get_post_meta( $post->ID, 'sidebar', true); if (!empty($right_sidebar )){ ?>
			<?php if ( is_active_sidebar( get_post_meta( $post->ID, 'sidebar', true) ) ) : ?>
                <div id="sidebar" class="single_sidebar custom_sidebar <?php echo $mobsidebar; ?>">
                    <div class="widgets">          
                            <?php dynamic_sidebar( get_post_meta( $post->ID, 'sidebar', true) ); ?>
                     </div>
                 </div>
    ...
    <?php }else{ ?>
				<?php if ( is_active_sidebar( 'sidebar' ) ) : ?>
                    <div id="sidebar" class="single_sidebar <?php echo $mobsidebar; ?>">
                        <div class="widgets">          
                                <?php dynamic_sidebar( 'sidebar' ); ?>
                         </div>
                     </div>
