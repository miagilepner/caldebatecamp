							...
							onclick: function() {
								...
								optimMceWindow();
									...
									jQuery('.divider_prevbtn').toggle(function(){
										...
										tinyMCE.triggerSave();
										//GET PREVIEW CONTENT
										var dvd_style = jQuery('.mce-dvd_style button span').text().toLowerCase();
							...
							onclick: function() {
								...
								optimMceWindow();
									...
									jQuery('.tdivider_prevbtn').toggle(function(){
										...
										var tdvd_style_raw = jQuery('.mce-tdvd_style button span').text()
										var tdvd_style = '';
							...
							onclick: function() {
								...
								optimMceWindow();
									...
									jQuery('.list_prevbtn').toggle(function(){
										...
										tinyMCE.triggerSave();
										//GET PREVIEW CONTENT	[EDIT]
										var list_style_raw = jQuery('.mce-liststyle button span').text()
										var list_style = '';
							...
							onclick: function() {
								...
								optimMceWindow();
									...
									jQuery('.button_prevbtn').toggle(function(){
										...
										var btn_style = jQuery('.mce-btn_style button span').text().toLowerCase();
										var btn_size = jQuery('.mce-btn_size button span').text().toLowerCase();
										...
										if(btn_text ==''){
											...
											var shortcontent = '<p style="text-align:center; margin-top:150px;"><a class="lts_button lts_button_'+btn_size+' '+btn_rounded+' lt_'+btn_style+'" style="background:'+btn_bg+';color:'+btn_color+'!important;border-color:'+btn_bg+';" href="'+btn_link+'">'+btn_icon+' ' +btn_text+'</a></p>';
										}
										//GET PREVIEW CONTENT END
										jQuery(this).addClass("short_prev_on");
...
/*----------------------------ICONS---------------------------*/
							...
							onclick: function() {
								editor.windowManager.open( {
									...
									onsubmit: function( e ) {
										editor.insertContent( '[icon type="' + e.data.buttonIconValue + '" color="' + e.data.iconColor + '" size="' + e.data.iconSize + '"]');
									}
								});
								//CALL THE COLORPICKER
								optimColpick();		
								...
								optimMceWindow();
									...
									jQuery('.icon_prevbtn').toggle(function(){
										...
										if(faicon ==''){
											...
											var shortcontent = '<p style="margin-top:50px;text-align:center;"><i style="color:'+faiconcolor+';font-size:'+faiconsize+';" class="fa '+faicon+'"></i></p>';
										}
										//GET PREVIEW CONTENT END
										jQuery(this).addClass("short_prev_on");
							...
							onclick: function() {
								...
								optimMceWindow();
									...
									jQuery('.headline_prevbtn').toggle(function(){
										...
										var headlinestyle = jQuery('.mce-headlinestyle button span').text();
										...
										var headlinesize = jQuery('.mce-headlinesize button span').text().toLowerCase()
							...
							onclick: function() {
								...
								optimMceWindow();
									...
									jQuery('.tabs_prevbtn').toggle(function(){
										...
										tinyMCE.triggerSave();
										//GET PREVIEW CONTENT	[EDIT]
										var tabs_style = jQuery('.mce-tabs_style button span').text().toLowerCase();
							...
							onclick: function() {
								...
								optimMceWindow();
									...
									jQuery('.slider_prevbtn').toggle(function(){
										...
										var slide_trans = jQuery('.mce-slide_trans button span').text().toLowerCase().replace(/ /g,"_");
							...
							onclick: function() {
								...
								optimMceWindow();
									...
									jQuery('.fblike_prevbtn').toggle(function(){
										...
										tinyMCE.triggerSave();
										//GET PREVIEW CONTENT
										var fbstyle = jQuery('.mce-fbstyle button span').text().toLowerCase().replace(/ /g,"_");
										var fbaction = jQuery('.mce-fbaction button span').text().toLowerCase().replace(/ /g,"_");
							...
							onclick: function() {
								...
								optimMceWindow();
									...
									jQuery('.twitter_prevbtn').toggle(function(){
										...
										tinyMCE.triggerSave();
										//GET PREVIEW CONTENT
										var twtsize = jQuery('.mce-twtsize button span').text().toLowerCase();
										if(twtsize =='standard'){var twtsize =''}
										if(twtsize =='big'){var twtsize ='data-size="large"' }
										var twtcount = jQuery('.mce-twtcount button span').text().toLowerCase();
							...
							onclick: function() {
								...
								optimMceWindow();
									...
									jQuery('.gplus_prevbtn').toggle(function(){
										...
										//GET PREVIEW CONTENT
										var gplustyle = jQuery('.mce-gplustyle button span').text().toLowerCase();
										if(gplustyle =='no count'){var gplustyle ='none'}
										
										var gplusize = jQuery('.mce-gplusize button span').text().toLowerCase();
							...
							onclick: function() {
								...
								optimMceWindow();
									...
									jQuery('.pin_prevbtn').toggle(function(){
										...
										//GET PREVIEW CONTENT
										var pinstyle = jQuery('.mce-pinstyle button span').text().toLowerCase();
										...
										var pinsize = jQuery('.mce-pinsize button span').text().toLowerCase();
							...
							onclick: function() {
								...
								optimMceWindow();
									...
									jQuery('.feat_prevbtn').toggle(function(){
										...
										var featimgalign = jQuery('.mce-featalign button span').text().toLowerCase();
							...
							onclick: function() {
								...
								optimMceWindow();
									...
									jQuery('.flickr_prevbtn').toggle(function(){
										...
										var flickrsize = jQuery('.mce-flickrsize button span').text().toLowerCase();
...
/*----------------------------LIGHTBOX SHORTCODE---------------------------*/
							...
							onclick: function() {
								editor.windowManager.open( {
									...
									var updatedHtml = jQuery('#' + getiframe + '').contents().find('body').html();
										editor.insertContent( '[lightbox button_text="' + e.data.lightboxTitle + '" button_text_color="' + e.data.lightboxButtonTxtColor + '" button_text_bg="' + e.data.lightboxButtonBgColor + '" button_font_size="' + e.data.lightboxButtonSize + '" rounded="' + e.data.lightboxButtonRounded + '"]' + updatedHtml + '[/lightbox]');
									}
								});
								...
								optimMceWindow();
									...
									jQuery('.lightbox_prevbtn').toggle(function(){
										...
										if(lightbtntxt =='' && lightboxmce ==''){
											...
											var shortcontent = '<span style="color:'+lightbtntxtcolor+';background:'+lightbtnbg+';font-size:'+lightbtnsize+'" class="lts_lightbox_bttn lt_animate '+lightbtncorner+'">'+lightbtntxt+'</span>';
										}
										//GET PREVIEW CONTENT END
										jQuery(this).addClass("short_prev_on");
...
/*----------------------------Progress Bar---------------------------*/
						{
							...
							onclick: function() {
								editor.windowManager.open( {
									...
									onsubmit: function( e ) {
										editor.insertContent( '[progress percent="' + e.data.prgrssbarProgress + '" background="' + e.data.prgrssbarBg + '"  color="' + e.data.prgrssbarColor + '"  rounded="' + e.data.prgrssbarRounded + '"  stripes="' + e.data.prgrssbarStripes + '"]');
									}
								});
								//CALL THE COLORPICKER
								optimColpick();		
								...
								optimMceWindow();
									...
									jQuery('.progress_prevbtn').toggle(function(){
										...
										if(prgrstxt ==''){
											...
											var shortcontent = '<div class="lts_progress '+prgrsround+' '+prgrstripe+'"><span>'+prgrstxt+'%</span><div class="lts_progress_wrap"><div title="'+prgrstxt+'%" class="lts_progress_inner" style="width:'+prgrstxt+'%;color:'+prgrscolor+';background-color:'+prgrsbg+';"></div></div></div>';
										}
										//GET PREVIEW CONTENT END
										jQuery(this).addClass("short_prev_on");
	...
	if(prc4_btnribon !==''){prc4_btnribon = '<span class="feat_wrap"><span class="pricebox_featured">'+prc4_btnribon+'</span></span>';}else{prc4_btnribon = '';}
		...
		if(prc4_name !==''){prc4 = '<div class="pricebox"><div class="pricebox_inner">'+prc4_btnribon+'<div class="price_head"><h3>'+prc4_name+'</h3><span class="price_ammount">'+prc4_price+'</span>'+prc4_label+'<p class="price_desc">'+prc4_desc+'</p></div><div class="price_body">'+prc4_feat+'</div><div class="price_footer"><a href="'+prc4_btnlink+'" class="price_button">'+prc4_btntxt+'</a></div></div></div>';}else{prc4 = '';}
										...
										if(prc1_name =='' && prc2_name ==''){
											...
											var shortcontent = '<div class="lts_pricing" style="color:'+prcolor+'" data-button-bg="'+prcbtnbg+'" data-button-txt="'+prcbtncolor+'" data-price-bg="'+prcbg+'" data-price-txt="'+prcolor+'">'+prc1+''+prc2+''+prc3+''+prc4+'</div>';
										}
										//GET PREVIEW CONTENT END
										jQuery(this).addClass("short_prev_on");
