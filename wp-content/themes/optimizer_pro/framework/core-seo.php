...
<meta property="og:image" content="<?php $thumb_id = get_post_thumbnail_id(); $thumb_url = wp_get_attachment_image_src($thumb_id,'medium', true); echo $thumb_url[0];?>"/>
...
<?php $twtphotoimage = wp_get_attachment_image_src( 'medium', '' ); ?>
