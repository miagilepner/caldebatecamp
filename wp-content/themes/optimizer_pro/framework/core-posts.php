...
function optimizer_posts($layout='1', $type='post', $count='6', $category='', $pages='', $previewbtn='2' , $linkbtn='1', $navigation='numbered'){
?>
	<?php  
	...
	if(isset($_REQUEST['pages'])){			$optimpages = strip_tags($_REQUEST['pages']);	}
